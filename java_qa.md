...
synchronized是关键字，ReentrantLock是类，ReentrantLock扩展性比synchronized好  
...
#### 二叉查找树与平衡二叉树的关系
二叉查找树满足左侧节点小于根节点，根节点小于右侧节点  
平衡二叉树满足二叉查找树的条件，同时任意节点的子树高度差小于2  

#### AVL树和红黑树的区别
AVL树：任意节点的子树高度差小于2，满足高度平衡代价高，适合查询操作多的情况  
红黑树：确保没有一条路径会比其它路径长出2倍，旋转次数少，适合搜索、插入、删除操作多的情况  
